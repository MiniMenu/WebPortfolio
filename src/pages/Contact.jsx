  ...
  const onSubmit =(e)=>{
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
      {
        ...
        to_name : 'minalabayasekara@gmail.com',
      ...
      setIsLoading(false);
      showAlert({show: true, text: 'Did not recieve message', type:'danger'});
  ...
  return (
    <section className="relative flex lg:flex-row flex-col max-container h-[100vh]">
      {alert.show && <Alert {...alert}/>}
          ...
          <form className="w-full flex flex-col gap-7 mt-14" onSubmit={onSubmit}>
             <label className="text-black-500 font-semibold"> 
              ...
              <label className="text-black-500 font-semibold"> 
                  ...
                  <textarea name="message" row={4}  className="textarea" placeholder="Write your thoughts here..." 
        ...
        <div className=" lg:w-1/2 w-full lg:h-auto md:f-[550px] h-[350px]">
